...
${OBJECTDIR}/UserList.o: UserList.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserList.o UserList.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -pthread -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
